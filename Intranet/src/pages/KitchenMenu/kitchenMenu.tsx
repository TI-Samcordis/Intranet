...
export default function KitchenMenu() {
  ...
  // Efeito visual de noite — secundário, ativa junto com jantar
  ...
  return (
    <main className={`${styles.main} ${isNoite ? styles.noite : ""}`}>
      ...
      {/* Sol → exibe almoço | Lua → exibe jantar + efeito noite */}
      ...
      <p className={styles.aviso}>
        As informações contidas nessa página são de responsabilidade do setor
        da nutrição. Em caso de dúvida, procurar o setor responsável.
      </p>
