    ...
    <div className={styles.dropdownTIContent}>
      <div className={styles.megaDropdown}>
        <div className={styles.megaColumn} style={{ marginLeft: "12%" }}>
          <h4>Dúvidas MV</h4>
          <NavLink action="mvsoul" onAction={onAction}>
            Acessar MvSoul
          </NavLink>
          <NavLink action="mvpep" onAction={onAction}>
            Acessar MvPep
          </NavLink>
          <NavLink action="chamado" onAction={onAction}>
            Abrir Chamado | OS
          </NavLink>
        </div>
        ...
        <div className={styles.megaColumn}>
          <h4>Ferramentas</h4>
          <NavLink action="hsp" onAction={onAction}>
            HSP
          </NavLink>
          <NavLink action="cloud" onAction={onAction}>
            Planner
          </NavLink>
          <NavLink action="sharepoint" onAction={onAction}>
            SharePoint
          </NavLink>
          <NavLink action="email" onAction={onAction}>
            Email | Outlook
          </NavLink>
          <NavLink action="teams" onAction={onAction}>
            Teams
          </NavLink>
          <NavLink action="idce" onAction={onAction}>
            iDCE
          </NavLink>
        </div>
        ...
        <div className={styles.megaColumn}>
          <h4>Contato</h4>
          <NavLink action="ramal" onAction={onAction}>
            Ramais
          </NavLink>
        </div>
      </div>
    ...
    <div className={styles.dropdownTIContent}>
      <div className={styles.megaDropdown}>
        <div className={styles.megaColumn} style={{ marginLeft: "9%" }}>
          ...
          <NavLink action="pfsense" onAction={onAction}>
            pfSense
          </NavLink>
          <NavLink action="idce" onAction={onAction}>
            iDCE
          </NavLink>
          <NavLink action="pacs" onAction={onAction}>
            PACS
          </NavLink>
          <NavLink action="rockstor" onAction={onAction}>
            Rockstor
          </NavLink>
          <NavLink action="kaspersky" onAction={onAction}>
            Kaspersky
          </NavLink>
          <NavLink action="fme" onAction={onAction}>
            Follow Me
          </NavLink>
          <NavLink action="intelbras" onAction={onAction}>
            Intelbras
          </NavLink>
        </div>
        ...
        <div className={styles.megaColumn}>
          <h4>TI</h4>
          <NavLink action="format" onAction={onAction}>
            Formatação
          </NavLink>
          <NavLink action="remoteService" onAction={onAction}>
            Atendimento Remoto
          </NavLink>
          <NavLink action="printerInstallation" onAction={onAction}>
            Instalação de Impressora
          </NavLink>
          <NavLink action="proxy" onAction={onAction}>
            Configuração de Proxy
          </NavLink>
          <NavLink action="exchangeOfPcs" onAction={onAction}>
            Troca de Máquinas | Backup
          </NavLink>
        </div>

        <div className={styles.megaColumn}>
          <h4>Financeiro</h4>
          <NavLink action="purchaseOrder" onAction={onAction}>
            Ordem de Compra
          </NavLink>
          <NavLink action="serviceEntrance" onAction={onAction}>
            Entrada de Serviço
          </NavLink>
          <NavLink action="productEntry" onAction={onAction}>
            Entrada de Produto
          </NavLink>
        </div>
        ...
        <div className={styles.megaColumn}>
          <h4>Contato</h4>
          <NavLink action="editRamal" onAction={onAction}>
            Ramais
          </NavLink>
        </div>
      </div>
      ...
      <div className={styles.navCenter}>
        ...
        <div className={styles.dropdown}>
          ...
          <div className={styles.dropdownContent}>
            {isTI ? (
              <NavLink action="cardapioNutri" onAction={onAction}>
                Cardápio
              </NavLink>
            ) : (
              <>
                <NavLink action="cardapio" onAction={onAction}>
                  Cardápio
                </NavLink>
              </>
            )}
